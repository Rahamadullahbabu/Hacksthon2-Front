...
function ResultInfo() {
  ...
  const getResult = async (values) => {
    try {
      ...
      const response = await axios.post(
        `https://hackback.onrender.com/results/get-result/${params.resultId}`,
        {},
        {
          headers: {
  ...
  const getStudents = async (values) => {
    try {
      dispatch(ShowLoading());
      const response = await axios.post(
        "https://hackback.onrender.com/student/get-all-students",
        {
          class: result.class,
        },
        {
  ...
  const saveStudentResult = async (values) => {
    ...
    try {
      dispatch(ShowLoading());
      const response = await axios.post(
        "https://hackback.onrender.com/results/save-student-result",
        {
